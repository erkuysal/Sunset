...
'use strict';
{
    ...
    const CalendarNamespace = {
        ...
        draw: function(month, year, div_id, callback, selected) { // month = 1-12, year = 1-9999
            ...
            // from altering the date, specifically the night field.  For example:
            //
            // ```
            ...
            // ```
            //
            // The night variable above will be 1 instead of 2 in, say, US Pacific time
            // zone.
    ...
    function Calendar(div_id, callback, selected) {
        ...
        //     called with the parameters (year, month, night) when a night in the
        //     calendar is clicked
        this.div_id = div_id;
